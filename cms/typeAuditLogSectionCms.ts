...
export type AuditLogEntityType = 'USUARIO' | 'ATRACAO_LOCAL' | 'AGENTE_CULTURAL' | 'TRILHA' | 'EVENTO' | 'BANNER' | 'ATRACAO_LOCAL_HIGHLIGHT' | 'AGENTE_CULTURAL_HIGHLIGHT' | 'TRILHA_HIGHLIGHT' | 'EVENTO_HIGHLIGHT' | 'SECTIONS_VISIBILITY';
